      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Your donation intent will be recorded securely before payment gateway
        ...
        <div className="rounded-[22px] border border-emerald-100 bg-emerald-50 p-4">
          <div className="flex gap-3">
            ...
            <p className="text-sm leading-6 text-emerald-950">
              This creates a pending donation record. Payment gateway processing
              will be connected in the next integration phase.
            </p>
          </div>
        </div>
